      ...
      pathPrefix("ants") {
        ...
        pathPrefix("config") {
          get {
              ...
              val appConfiguration = new AppConfiguration(this.antNumber,this.destination_x,this.destination_y)
...
object MainServer extends App with Service {
